          ...
          <div class=" card-body container max-w-lg">
            ...
            <div class="" id="">
              ...
              <div v-if="activeTab === 'visionmission'" class="tab-pane fade show active">
                <h1 class="entry-title text-center mb-8"><strong>Mission and Vision</strong></h1>
                ...
                <div class="flex justify-between items-center mb-8">
                  ...
                  <div class="flex-1 text-center">
                    <!-- Placeholder for Core Values icon if needed -->
                  </div>
                </div>
                ...
                <div class="flex justify-between items-start gap-8">
                  ...
                  <div class="flex-1 max-w-md">
                    <div class="content-box p-4">
                      ...
                      <p class="text-center mb-4">An innovative, safe, and happy nation that thrives through and is enabled by Information and Communications Technology.</p>
                      <p class="text-center">DICT aspires for the Philippines to develop and flourish through innovation and constant development of ICT in the pursuit of a progressive, safe, secured, contented, and happy Filipino nation.</p>
                    </div>
                  </div>
                    ...
                    <div class="container mx-auto mt-4" style="max-width: 1500px;">
                      <div class="">
                        ...
                        <div class="items-center p-1">
                          <h3 class="text-center mb-2 "><strong>Quality Policy</strong></h3>
                          <p class="text-center mb-3 "><i>QPL/r0/01Feb24</i></p>
              ...
              <div v-if="activeTab === 'qualityobjectives'" class="tab-pane fade show  ">
                     ...
                     <div class="card border rounded-lg shadow-lg">
                        ...
                        <ol>
                            ...
                            <li>To maintain complete inventory of property, plant, and equipment (PPE) and efficient process of provision of supply in the office and equipment to property custodians.</li>
                            <li>To maintain 90% of the buildings and facilities as well as the 100% of the official vehicles in good condition to provide personnel conducive workspaces and ensure safe travels respectively.</li>
              ...
              <div v-if="activeTab === 'contactus'" class="tab-pane fade show ">
                <div class="container mx-auto mt-4" style="max-width: 1500px;">
                      <div class="">
                <div class="    " style="padding-top: 100px;"> <!-- Adjust padding-top as needed -->
