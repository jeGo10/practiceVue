<!-- resources/js/Pages/Archive/Partials/CreateArchive.vue -->
<script setup>
import { ref } from 'vue';
...
const submit = () => {
    form.post(route('archives.store'), {
        // Emit the archive details to the parent component
...
<template>
    <div>
        ...
        <PrimaryButton @click="showModal">Create New Archive</PrimaryButton>

        <!-- Modal for creating new archive -->
        <Modal :show="creatingArchive" @close="closeModal">
            <!-- Modal Head -->
            <div class="flex items-center justify-between p-4 border-b rounded-t">
                <h3 class="text-xl">Create New Archive</h3>
                <button
                    type="button"
